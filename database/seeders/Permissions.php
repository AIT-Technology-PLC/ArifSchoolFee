...
class Permissions extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::transaction(function () {
            ...
            $permissions[] = Permission::firstOrCreate(['name' => 'Import Attendance']);
            ...
            $permissions[] = Permission::firstOrCreate(['name' => 'Read Credit Report']);
            ...
            // ItemType
            $permissions[] = Permission::firstOrCreate(['name' => 'Create ItemType']);
            $permissions[] = Permission::firstOrCreate(['name' => 'Read ItemType']);
            $permissions[] = Permission::firstOrCreate(['name' => 'Update ItemType']);
            $permissions[] = Permission::firstOrCreate(['name' => 'Delete ItemType']);
            $permissions[] = Permission::firstOrCreate(['name' => 'Import ItemType']);
            ...
            $permissions[] = Permission::firstOrCreate(['name' => 'Read Inventory Valuation Report']);
            ...
            $permissions[] = Permission::firstOrCreate(['name' => 'Read Inventory In Transit Report']);
