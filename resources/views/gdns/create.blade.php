            ...
            <div class="box radius-bottom-0 mb-0 radius-top-0">
                ...
                <div class="box has-background-white-bis radius-top-0">
                    <div name="gdnFormGroup" class="columns is-marginless is-multiline">
                        ...
                        <div class="column is-12">
                            <div class="field">
                                <label for="gdn[0][description]" class="label text-green has-text-weight-normal">Description</label>
                                <div class="control has-icons-left">
                    ...
                    @if (old('gdn.' . $i . '.product_id') || old('gdn.' . $i . '.quantity'))
                        ...
                        <div class="box has-background-white-bis radius-top-0">
                            <div name="gdnFormGroup" class="columns is-marginless is-multiline">
                                ...
                                <div class="column is-12">
                                    <div class="field">
                                        <label for="gdn[{{ $i }}][description]" class="label text-green has-text-weight-normal">Additional Notes</label>
                                        <div class="control has-icons-left">
