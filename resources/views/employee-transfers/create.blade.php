...
@section('title', 'Create New Employee Transfer')
...
@section('content')
    <x-common.content-wrapper>
        ...
        <form
            id="formOne"
            action="{{ route('employee-transfers.store') }}"
            method="POST"
        ...
        >
                        ...
                        <x-forms.field>
                            ...
                            <x-forms.control class="has-icons-left">
                                <x-forms.input
                                    ...
                                    name="code"
                                    id="code"
                                    value="{{ $currentEmployeeTransferNo }}"
                                />
                                <x-common.icon
                                    name="fas fa-hashtag"
            ...
            @include('employee-transfers.partials.details-form', ['data' => session()->getOldInput()])
