...
@section('title', 'Employee Transfer Details')
            ...
            <div class="columns is-marginless is-multiline">
                ...
                <div class="column is-6">
                    <x-common.show-data-section
                        ...
                        :data="$employeeTransfer->issued_on->toFormattedDateString()"
                        label="Issued On"
                    />
                </div>
            </div>
        ...
        >
            <x-common.dropdown name="Actions">
                @if (!$employeeTransfer->isApproved())
                    @can('Approve Employee Transfer')
                        <x-common.dropdown-item>
                            <x-common.transaction-button
                                :route="route('employee-transfers.approve', $employeeTransfer->id)"
                                action="approve"
                ...
                <x-common.dropdown-item>
                    <x-common.button
                        tag="a"
                        href="{{ route('employee-transfers.edit', $employeeTransfer->id) }}"
                        mode="button"
                        icon="fas fa-pen"
                        label="Edit"
                        class="has-text-weight-medium is-small text-green is-borderless is-transparent-color is-block is-fullwidth has-text-left"
