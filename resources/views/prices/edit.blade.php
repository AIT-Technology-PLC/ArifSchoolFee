            ...
            <div class="box radius-bottom-0 mb-0 radius-top-0">
                <div class="columns is-marginless is-multiline">
                    <div class="column is-6">
                        <div class="field">
                            <label for="product_id" class="label text-green has-text-weight-normal"> Products <sup class="has-text-danger">*</sup> </label>
                    ...
                    <div class="column is-6">
                        <div class="field">
                            ...
                            <div class="control has-icons-left">
                                <input id="price" name="price" type="number" class="input" placeholder="Sale Price" value="{{ $price->price }}">
