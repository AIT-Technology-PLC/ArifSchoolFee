...
@section('content')
    <x-common.content-wrapper>
        <x-content.header title="Edit Payroll" />
        <form
            id="formOne"
                        ...
                        <x-forms.field>
                            ...
                            <x-forms.control class="has-icons-left">
                                <x-forms.input
                                    ...
                                    value="{{ $payroll->issued_on->toDateTimeLocalString() }}"
                                />
                                <x-common.icon
                        ...
                        <x-forms.field>
                            ...
                            <x-forms.control class="has-icons-left">
                                <x-forms.input
                                    ...
                                    id="starting_period"
                                    placeholder="mm/dd/yyyy"
                                    value="{{ $payroll->starting_period->toDateString() }}"
                                />
                                <x-common.icon
                                    name="fas fa-calendar-alt"
                                    class="is-small is-left"
                        ...
                        <x-forms.field>
                            ...
                            <x-forms.control class="has-icons-left">
                                <x-forms.input
                                    ...
                                    id="ending_period"
                                    placeholder="mm/dd/yyyy"
                                    value="{{ $payroll->ending_period->toDateString() }}"
                                />
                                <x-common.icon
                                    name="fas fa-calendar-alt"
                                    class="is-small is-left"
