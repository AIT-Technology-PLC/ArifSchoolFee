...
@section('content')
    <section class="mt-3 mx-3 m-lr-0">
        ...
        <form action="{{ route('warehouses.store') }}" method="post" enctype="multipart/form-data" novalidate>
            @csrf
                ...
                <div class="columns is-marginless is-multiline">
                    ...
                    <div class="column is-6">
                        <div class="field">
                            ...
                            <div class="control has-icons-left">
                                <input id="location" name="location" type="text" class="input" placeholder="Location: Building, Street" value="{{ old('location') ?? '' }}">
                                <span class="icon is-small is-left">
