...
@section('content')
    <section class="mt-3 mx-3 m-lr-0">
        ...
        <form id="formOne" action="{{ route('warehouses.update', $warehouse->id) }}" method="post" enctype="multipart/form-data" novalidate>
            @csrf
            @method('PATCH')
                ...
                <div class="columns is-marginless is-multiline">
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <label class="radio has-text-grey has-text-weight-normal">
                                    <input type="radio" name="is_sales_store" value="1" class="mt-3" {{ $warehouse->is_sales_store ? 'checked' : '' }}>
                                    Sales Store
                                </label>
                                <label class="radio has-text-grey has-text-weight-normal mt-2">
                                    <input type="radio" name="is_sales_store" value="0" {{ $warehouse->is_sales_store ? '' : 'checked' }}>
                                    Main Store
                                </label>
                    ...
                    <div class="column is-6">
                        <div class="field">
                            ...
                            <div class="control">
                                <label class="radio has-text-grey has-text-weight-normal">
                                    <input type="radio" name="can_be_sold_from" value="1" class="mt-3" {{ $warehouse->can_be_sold_from ? 'checked' : '' }}>
                                    Yes
                                </label>
                                <label class="radio has-text-grey has-text-weight-normal mt-2">
                                    <input type="radio" name="can_be_sold_from" value="0" {{ $warehouse->can_be_sold_from ? '' : 'checked' }}>
                                    No
                                </label>
                    ...
                    <div class="column is-6">
                        <div class="field">
                            ...
                            <div class="control has-icons-left">
                                <input id="email" name="email" type="text" class="input" placeholder="Email Address" value="{{ $warehouse->email ?? '' }}">
                                <span class="icon is-small is-left">
                                    <i class="fas fa-at"></i>
                                </span>
                                @error('email')
                    ...
                    <div class="column is-6">
                        <div class="field">
                            ...
                            <div class="control has-icons-left">
                                <input id="phone" name="phone" type="text" class="input" placeholder="Phone/Telephone" value="{{ $warehouse->phone ?? '' }}">
                                <span class="icon is-small is-left">
                    ...
                    <div class="column is-6">
                        <div class="field">
                            ...
                            <div class="control has-icons-left">
                                <input id="address" name="address" type="text" class="input" placeholder="Address" value="{{ $warehouse->address ?? '' }}">
                                <span class="icon is-small is-left">
