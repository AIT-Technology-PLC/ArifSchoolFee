...
>
    ...
    <div class="modal-content">
        ...
        >
            @csrf
            <x-content.main x-data="customerForm">
                        ...
                        <x-forms.field>
                            ...
                            <div class="file has-name">
                                <label class="file-label">
                                    ...
                                    <span
                                        class="file-name"
                                        x-text="fileName || customer.business_license_attachment || 'Select File...'"
                                    >
                                    </span>
                                </label>
                            </div>
                        ...
                        <x-forms.field>
                            ...
                            <x-forms.control class="has-icons-left">
                                <x-forms.input
                                    ...
                                    x-model="customer.business_license_expires_on"
                                />
                                <x-common.icon
        ...
        document.addEventListener("alpine:init", () => {
            Alpine.data("customerForm", (customer = {}) => ({
                ...
                changeProperties(customer) {
                    ...
                    this.customer.business_license_attachment = customer.business_license_attachment || '';
                    this.customer.business_license_expires_on = customer.business_license_expires_on || '';
                }
            }));
        });
    </script>
