...
@section('title', 'Edit General Tender Checklist')

@section('content')
    <x-common.content-wrapper>
        <x-content.header title="Edit General Tender Checklist" />
        <form
            id="formOne"
            action="{{ route('general-tender-checklists.update', $generalTenderChecklist->id) }}"
            method="post"
                        ...
                        <x-forms.field>
                            ...
                            <x-forms.control class="has-icons-left">
                                <x-forms.input
                                    ...
                                    value="{{ $generalTenderChecklist->item }}"
                                />
                                <x-common.icon
                                    name="fas fa-check"
                                ...
                                >
                                    ...
                                    @foreach ($tenderChecklistTypes as $tenderChecklistType)
                                        <option
                                            ...
                                            {{ $generalTenderChecklist->tender_checklist_type_id == $tenderChecklistType->id ? 'selected' : '' }}
