...
@section('title', 'Create New Earning')

@section('content')
    <x-common.content-wrapper>
        <x-content.header title="New Earning" />
        <form
            id="formOne"
        ...
        >
            ...
            @include('earnings.partials.details-form', ['data' => session()->getOldInput()])
