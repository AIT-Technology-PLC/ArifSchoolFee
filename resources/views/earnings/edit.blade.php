...
@section('content')
    <x-common.content-wrapper>
        <x-content.header title="Edit Earning" />
        <form
            id="formOne"
            action="{{ route('earnings.update', $earning->id) }}"
            method="POST"
        ...
        >
                    ...
                    <div class="column is-6">
                        <x-forms.field>
                            <x-forms.label for="code">
                                Earning Number <sup class="has-text-danger">*</sup>
                            </x-forms.label>
                        ...
                        <x-forms.field>
                            ...
                            <x-forms.control class="has-icons-left">
                                <x-forms.input
                                    ...
                                    value="{{ $earning->starting_period->toDateTimeLocalString() }}"
                                />
                                <x-common.icon
                        ...
                        <x-forms.field>
                            ...
                            <x-forms.control class="has-icons-left">
                                <x-forms.input
                                    ...
                                    id="ending_period"
                                    placeholder="mm/dd/yyyy"
                                    value="{{ $earning->ending_period->toDateTimeLocalString() }}"
                                />
                                <x-common.icon
                                    name="fas fa-calendar-alt"
                                    class="is-large is-left"
            ...
            @include('earnings.partials.details-form', ['data' => ['earning' => old('earning') ?? $earningDetails]])
