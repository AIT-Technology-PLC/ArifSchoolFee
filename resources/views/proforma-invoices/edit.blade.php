                    ...
                    <div class="column is-6 {{ userCompany()->isDiscountBeforeVAT() ? 'is-hidden' : '' }}">
                        ...
                        <div class="field">
                            <div class="control has-icons-left is-expanded">
                                <input id="discount" name="discount" type="number" class="input" placeholder="Discount in Percentage" value="{{ $proformaInvoice->discount * 100 ?? '' }}">
                                ...
                                <div name="proformaInvoiceFormGroup" class="columns is-marginless is-multiline">
                                    <div class="column is-6">
                                        <div class="field">
                                            ...
                                            <div class="control has-icons-left">
                                                <x-common.product-list tags="true" name="proformaInvoice[{{ $loop->index }}]" selected-product-id="{{ $proformaInvoiceDetail->product_id ?? $proformaInvoiceDetail->custom_product }}" />
                                                <div class="icon is-small is-left">
                                                    <i class="fas fa-th"></i>
                                                </div>
                                    ...
                                    <div class="column is-6">
                                        ...
                                        <div class="field has-addons">
                                            <div class="control has-icons-left is-expanded">
                                                <input id="proformaInvoice[{{ $loop->index }}][unit_price]" name="proformaInvoice[{{ $loop->index }}][unit_price]" type="number" class="input" placeholder="Unit Price" value="{{ $proformaInvoiceDetail->originalUnitPrice ?? '0.00' }}">
                                                <span class="icon is-small is-left">
