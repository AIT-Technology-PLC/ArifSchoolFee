                        ...
                        <div class="field">
                            ...
                            <div class="control has-icons-left">
                                <div class="select is-fullwidth">
                                    <x-common.customer-list :selected-customer-id="$proformaInvoice->customer_id ?? ''" />
                                </div>
                    ...
                    <div class="column is-12">
                        <div class="field">
                            ...
                            <div class="control">
                                ...
                                >{{ $proformaInvoice->terms ?? '' }}</textarea>
                                @error('terms')
                                    <span
                                        class="help has-text-danger"
                                        role="alert"
                        ...
                        <div class="proforma-invoice-detail mx-3">
                            ...
                            <div
                                x-data="productDataProvider({{ $proformaInvoiceDetail->product_id ??
                                    str($proformaInvoiceDetail->custom_product)->append('\'')->prepend('\'') }}, {{ $proformaInvoiceDetail->originalUnitPrice ?? 0.0 }})"
                                        ...
                                        <div class="field">
                                            <div class="control has-icons-left is-expanded">
                                                <input
                                                    ...
                                                    class="input"
                                                    placeholder="Discount in Percentage"
                                                    value="{{ $proformaInvoiceDetail->discount * 100 ?? '' }}"
                                                >
                                                <span class="icon is-small is-left">
                                                    <i class="fas fa-percent"></i>
                                                </span>
