                        ...
                        <div class="field">
                            ...
                            <div class="control has-icons-left">
                                <input
                                    ...
                                    value="{{ $purchase->purchased_on ? $purchase->purchased_on->toDateString() : '' }}"
                                >
                            ...
                            <div class="control has-icons-left">
                                <div class="select is-fullwidth">
                                    ...
                                    >
                                        ...
                                        <option
                                            value="Cash Payment"
                                            {{ $purchase->payment_type == 'Cash Payment' ? 'selected' : '' }}
                                        >Cash Payment</option>
                                        <option
                                            value="Credit Payment"
                                            {{ $purchase->payment_type == 'Credit Payment' ? 'selected' : '' }}
                                ...
                                <div class="field has-addons">
                                    <div class="control has-icons-left is-expanded">
                                        <input
                                            ...
                                            value="{{ $purchaseDetail->originalUnitPrice ?? '' }}"
                                        >
                                        <span class="icon is-small is-left">
                                ...
                                <div class="field">
                                    <div class="control has-icons-left is-expanded">
                                        <input
                                            ...
                                            class="input"
                                            placeholder="Discount in Percentage"
                                            value="{{ $purchaseDetail->discount * 100 ?? '' }}"
                                        >
                                        <span class="icon is-small is-left">
                                            <i class="fas fa-percent"></i>
                                        </span>
