                            ...
                            <div class="box has-background-white-bis radius-top-0">
                                <div class="columns is-marginless is-multiline">
                                    ...
                                    <div class="column is-6 {{ userCompany()->isDiscountBeforeVAT() ? '' : 'is-hidden' }}">
                                        ...
                                        <div class="field">
                                            <div class="control has-icons-left is-expanded">
                                                <input id="purchase[{{ $loop->index }}][discount]" name="purchase[{{ $loop->index }}][discount]" type="number" class="input" placeholder="Discount in Percentage" value="{{ $purchaseDetail['discount'] ?? '' }}">
                                                <span class="icon is-small is-left">
                                                    <i class="fas fa-percent"></i>
                                                </span>
