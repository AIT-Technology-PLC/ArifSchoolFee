                                ...
                                <x-forms.control class="has-icons-left ">
                                    ...
                                    >
                                        ...
                                        @foreach ($branches as $branch)
                                            <option
                                                value="{{ $branch->id }}"
                                                @selected($branch->id == (old('warehouse_id', $student->warehouse->id)))
                                            >
                                ...
                                <x-forms.control class="has-icons-left ">
                                    ...
                                    >
                                        ...
                                        @foreach ($classes as $class)
                                            <option
                                                value="{{ $class->id }}"
                                                @selected($class->id == (old('school_class_id', $student->schoolClass->id)))
                                            >
                                ...
                                <x-forms.control class="has-icons-left ">
                                    ...
                                    >
                                        ...
                                        @foreach ($sections as $sections)
                                            <option
                                                value="{{ $sections->id }}"
                                                @selected($sections->id == (old('section_id', $student->section->id)))
                                            >
                                ...
                                <x-forms.control class="has-icons-left ">
                                    ...
                                    >
                                        ...
                                        @foreach ($categories as $category)
                                            <option
                                                value="{{ $category->id }}"
                                                @selected($category->id == (old('student_category_id', $student->studentCategory->id)))
                                            >
                                ...
                                <x-forms.control class="has-icons-left ">
                                    ...
                                    >
                                        ...
                                        @foreach ($groups as $group)
                                            <option
                                                value="{{ $group->id }}"
                                                @selected($group->id == (old('student_group_id', $student->studentGroup->id)))
                                            >
                            ...
                            <x-forms.field>
                                ...
                                <x-forms.control class="has-icons-left ">
                                    ...
                                    >
                                        ...
                                        <option
                                            value="male"
                                            @selected($student->gender ?? old('gender') == 'male')
                                        >
                                            Male
                                        </option>
                                        <option
                                            value="female"
                                            @selected($student->gender ?? old('gender') == 'female')
                                        >
                                            Female
                                        </option>
                                    </x-forms.select>
                            ...
                            <x-forms.field>
                                ...
                                <x-forms.control class="has-icons-left is-fullwidth">
                                    <x-forms.input
                                        ...
                                        value="{{ $student->date_of_birth ?? old('date_of_birth') }}"
                                    />
                                    <x-common.icon
                                    ...
                                    >
                                        ...
                                        @foreach ($academicYears as $academicYear)
                                            <option
                                                ...
                                                @selected($academicYear->id == (old('academic_year_id', $student->academicYear->id)))
                                            >
                            ...
                            <x-forms.field>
                                ...
                                <x-forms.control class="has-icons-left is-fullwidth">
                                    <x-forms.input
                                        ...
                                        type="date"
                                        placeholder="mm/dd/yyyy"
                                        value="{{ $student->admission_date ?? old('admission_date') }}"
                                    />
                                    <x-common.icon
                                        name="fas fa-calendar-alt"
                                        class="is-small is-left"
                                ...
                                <x-forms.control class="has-icons-left ">
                                    ...
                                    >
                                        ...
                                        @foreach ($routes as $route)
                                            <option
                                                value="{{ $route->id }}"
                                                @selected($route->id == (old('route_id', $student->route?->id)))
                                            >
                                ...
                                <x-forms.control class="has-icons-left ">
                                    ...
                                    >
                                        ...
                                        @foreach ($vehicles as $vehicle)
                                            <option
                                                value="{{ $vehicle->id }}"
                                                @selected($vehicle->id == (old('vehicle_id', $student->vehicle?->id)))
                                            >
                            ...
                            <x-forms.field>
                                ...
                                <x-forms.control class="has-icons-left">
                                    <x-forms.input
                                        ...
                                        value="{{ $student->currenct_address ?? old('current_address') }}"
                                    />
                                    <x-common.icon
