...
@section('title', 'Create New Tender Checklist Type')

@section('content')
    <x-common.content-wrapper>
        <x-content.header title=" New Tender Checklist Type" />
        <form
            id="formOne"
            action="{{ route('tender-checklist-types.store') }}"
            method="post"
