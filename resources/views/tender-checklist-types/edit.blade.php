                ...
                <div class="columns is-marginless is-multiline">
                    <div class="column is-6">
                        <div class="field">
                            ...
                            <div class="control has-icons-left">
                                <input id="name" name="name" type="text" class="input" placeholder="Checklist Name" value="{{ $tenderChecklistType->name }}">
                            ...
                            <div class="control has-icons-left">
                                <div class="select is-fullwidth">
                                    <select id="is_sensitive" name="is_sensitive">
                                        <option value="1" {{ $tenderChecklistType->is_sensitive ? 'selected' : '' }}> Yes, confidential </option>
                                        <option value="0" {{ $tenderChecklistType->is_sensitive ? '' : 'selected' }}> Not confidential </option>
                                    </select>
                                </div>
                    ...
                    <div class="column is-6">
                        <div class="field">
                            ...
                            <div class="control has-icons-left">
                                <textarea name="description" id="description" cols="30" rows="3" class="textarea pl-6" placeholder="Description or note about this checklist">{{ $tenderChecklistType->description }}</textarea>
