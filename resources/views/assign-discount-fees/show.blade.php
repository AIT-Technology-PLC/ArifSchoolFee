...
@section('title', 'Assign Fee Discount')
...
@section('content')
    <x-common.content-wrapper>
        <x-content.header>
            <x-slot name="header">
                <span class="tag bg-softblue has-text-white has-text-weight-normal ml-1 m-lr-0">
                    ...
                    <span>
                        Selection Criteria ( {{ $assignDiscountFee->name }} - {{ $assignDiscountFee->amount }} )
                    </span>
                </span>
            </x-slot>
        </x-content.header>
        <x-content.footer>
            ...
            <form
                id="formOne"
                action="{{ route('assign-discount-fees.update', $assignDiscountFee->id) }}"
                method="POST"
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            var table = $('#assign-discount-fees-datatable').DataTable();
