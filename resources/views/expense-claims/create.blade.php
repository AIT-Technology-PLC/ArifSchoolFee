...
@section('title', 'Create Expense Claims')

@section('content')
    <x-common.content-wrapper>
        <x-content.header title="New Expense Claims" />
        <form
            id="formOne"
            action="{{ route('expense-claims.store') }}"
            method="POST"
        ...
        >
                                ...
                                >
                                    @foreach ($users as $user)
                                        <option
                                            ...
                                            @selected(old('employee_id') == $user->employee->id)
                                        >{{ $user->name }}</option>
                                    @endforeach
                                </x-forms.select>
                                <x-common.icon
            ...
            @include('expense-claims.partials.details-form', ['data' => session()->getOldInput()])
