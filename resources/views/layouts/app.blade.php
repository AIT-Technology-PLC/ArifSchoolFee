...
<head>
    ...
    {{-- Local Assets --}}
    <link href="{{ asset('css/app.css?' . config('assets.css_version')) }}" rel="stylesheet">
</head>
...
<body class="has-navbar-fixed-top">
    ...
    {{-- Local Assets --}}
    <script src="{{ asset('js/app.js?' . config('assets.js_version')) }}" defer></script>
    <script src="{{ asset('js/caller.js?' . config('assets.js_version')) }}" defer></script>
