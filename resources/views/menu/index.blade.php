...
@section('content')
    <x-common.content-wrapper>
        @if (isFeatureEnabled('Bill Of Material Management', 'Job Management'))
            ...
            @endcanany
        @endif
        @if (isFeatureEnabled('Department Management', 'Employee Management', 'Employee Transfer', 'Warning Management', 'Leave Management'))
            @canany(['Read Employee', 'Read Department', 'Read Employee Transfer', 'Read Warning', 'Read Leave'])
                <section class="mb-5">
                    <x-content.header>
                        <x-slot name="header">
                            <span class="icon">
