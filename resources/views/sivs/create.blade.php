                    ...
                    <div class="column is-6">
                        <div class="field">
                            ...
                            <div class="control has-icons-left">
                                <input class="input" type="number" name="code" id="code" value="{{ $currentSivCode }}">
                    ...
                    <div name="sivFormGroup" class="columns is-marginless is-multiline">
                        <div class="column is-6">
                            <div class="field">
                                ...
                                <div class="control has-icons-left">
                                    <x-common.product-list tags="false" name="siv[0]" selected-product-id="{{ old('siv.0.product_id') }}" />
                                    <div class="icon is-small is-left">
                                        <i class="fas fa-th"></i>
                                    </div>
                            ...
                            <div name="sivFormGroup" class="columns is-marginless is-multiline">
                                <div class="column is-6">
                                    <div class="field">
                                        ...
                                        <div class="control has-icons-left">
                                            <x-common.product-list tags="false" name="siv[{{ $i }}]" selected-product-id="{{ old('siv.' . $i . '.product_id') }}" />
                                            <div class="icon is-small is-left">
                                                <i class="fas fa-th"></i>
                                            </div>
