                    ...
                    <div class="column is-6">
                        <div class="field">
                            ...
                            <div class="control has-icons-left">
                                <input class="input" type="number" name="code" id="code" value="{{ $currentGrnCode }}">
                    ...
                    <div name="grnFormGroup" class="columns is-marginless is-multiline">
                        <div class="column is-6">
                            <div class="field">
                                ...
                                <div class="control has-icons-left">
                                    <x-common.product-list tags="false" name="grn[0]" selected-product-id="{{ old('grn.0.product_id') }}" />
                                    <div class="icon is-small is-left">
                                        <i class="fas fa-th"></i>
                                    </div>
                        ...
                        <div class="column is-6">
                            <div class="field">
                                <label for="grn[0][description]" class="label text-green has-text-weight-normal">Additional Notes <sup class="has-text-danger"></sup></label>
                                <div class="control has-icons-left">
                            ...
                            <div name="grnFormGroup" class="columns is-marginless is-multiline">
                                <div class="column is-6">
                                    <div class="field">
                                        ...
                                        <div class="control has-icons-left">
                                            <x-common.product-list tags="false" name="grn[{{ $i }}]" selected-product-id="{{ old('grn.' . $i . '.product_id') }}" />
                                            <div class="icon is-small is-left">
                                                <i class="fas fa-th"></i>
                                            </div>
                                ...
                                <div class="column is-6">
                                    <div class="field">
                                        <label for="grn[{{ $i }}][description]" class="label text-green has-text-weight-normal">Additional Notes <sup class="has-text-danger"></sup></label>
                                        <div class="control has-icons-left">
