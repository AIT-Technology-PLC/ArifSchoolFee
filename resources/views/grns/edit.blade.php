...
@section('content')
    <x-common.content-wrapper>
        <x-content.header title="Edit GRN" />
        <form
            id="formOne"
        ...
        >
            ...
            <x-content.main>
                <div class="columns is-marginless is-multiline">
                        ...
                        <div class="column is-6">
                            <x-forms.field>
                                ...
                                <x-forms.control class="has-icons-left select is-fullwidth">
                                    <x-common.supplier-list :selected-id="old('supplier_id', $grn->supplier_id)" />
                                    <x-common.icon
                    ...
                    <x-common.custom-field-form
                        model-type="grn"
                        :input="old('customField') ?? $grn->customFieldsAsKeyValue()"
                    />
            ...
            @include('grns.partials.details-form', ['data' => ['grn' => old('grn') ?? $grn->grnDetails]])
