                    ...
                    <div name="adjustmentFormGroup" class="columns is-marginless is-multiline">
                        <div class="column is-6">
                            <div class="field">
                                ...
                                <div class="control has-icons-left">
                                    <x-product-list model="adjustment" selected-product_id="{{ old('adjustment.0.product_id') }}"/>
                                    <div class="icon is-small is-left">
                                        <i class="fas fa-th"></i>
                                    </div>
                            ...
                            <div name="adjustmentFormGroup" class="columns is-marginless is-multiline">
                                <div class="column is-6">
                                    <div class="field">
                                        ...
                                        <div class="control has-icons-left">
                                            <x-product-list model="adjustment" selected-product_id="{{ old('adjustment.' . $i . '.product_id') }}"/>
                                            <div class="icon is-small is-left">
                                                <i class="fas fa-th"></i>
                                            </div>
