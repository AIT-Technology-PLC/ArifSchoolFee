                    ...
                    <div name="adjustmentFormGroup" class="columns is-marginless is-multiline">
                        <div class="column is-6">
                            <div class="field">
                                ...
                                <div class="control has-icons-left">
                                    <x-product-list name="adjustment[0]" selected-product-id="{{ old('adjustment.0.product_id') }}"/>
                                    <div class="icon is-small is-left">
                                        <i class="fas fa-th"></i>
                                    </div>
                        ...
                        <div class="column is-6">
                            <div class="field">
                                <label for="adjustment[0][is_subtract]" class="label text-green has-text-weight-normal"> Operation <sup class="has-text-danger">*</sup> </label>
                                <div class="control has-icons-left">
                            ...
                            <div name="adjustmentFormGroup" class="columns is-marginless is-multiline">
                                <div class="column is-6">
                                    <div class="field">
                                        ...
                                        <div class="control has-icons-left">
                                            <x-product-list name="adjustment[{{ $i }}]" selected-product-id="{{ old('adjustment.' . $i . '.product_id') }}"/>
                                            <div class="icon is-small is-left">
                                                <i class="fas fa-th"></i>
                                            </div>
                                ...
                                <div class="column is-6">
                                    <div class="field">
                                        <label for="adjustment[{{ $i }}][is_subtract]" class="label text-green has-text-weight-normal"> Operation <sup class="has-text-danger">*</sup> </label>
                                        <div class="control has-icons-left">
                                            <div class="select is-fullwidth">
