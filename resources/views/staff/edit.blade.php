                                ...
                                <x-forms.control class="has-icons-left ">
                                    ...
                                    >
                                        ...
                                        @foreach ($branches as $branch)
                                            <option
                                                value="{{ $branch->id }}"
                                                @selected($branch->id == (old('warehouse_id', $staff->warehouse->id)))
                                            >
                                ...
                                <x-forms.control class="has-icons-left ">
                                    ...
                                    >
                                        ...
                                        @foreach ($departments as $department)
                                            <option
                                                value="{{ $department->id }}"
                                                @selected($department->id == (old('department_id', $staff->department->id)))
                                            >
                                    ...
                                    >
                                        ...
                                        @foreach ($designations as $designation)
                                            <option
                                                ...
                                                @selected($designation->id == (old('designation_id', $staff->designation->id)))
                                            >
                            ...
                            <x-forms.field>
                                ...
                                <x-forms.control class="has-icons-left">
                                    <x-forms.input
                                        ...
                                        value="{{ $staff->first_name ?? old('first_name') }}"
                                    />
                                    <x-common.icon
                                        name="fas fa-user"
                                        class="is-small is-left"
                            ...
                            <x-forms.field>
                                ...
                                <x-forms.control class="has-icons-left">
                                    <x-forms.input
                                        ...
                                        value="{{ $staff->last_name ?? old('last_name') }}"
                                    />
                                    <x-common.icon
                                        name="fas fa-user"
                                        class="is-small is-left"
                            ...
                            <x-forms.field>
                                ...
                                <x-forms.control class="has-icons-left ">
                                    ...
                                    >
                                        ...
                                        <option
                                            value="male"
                                            @selected($staff->gender ?? old('gender') == 'male')
                                        >
                                            Male
                                        </option>
                                        <option
                                            value="female"
                                            @selected($staff->gender ?? old('gender') == 'female')
                                        >
                                            Female
                                        </option>
                                    </x-forms.select>
                            ...
                            <x-forms.field>
                                ...
                                <x-forms.control class="has-icons-left ">
                                    ...
                                    >
                                        ...
                                        <option
                                            value="married"
                                            @selected($staff->marital_status ?? old('marital_status') == 'married')
                                        >
                                            Married
                                        </option>
                                        <option
                                            value="single"
                                            @selected($staff->marital_status ?? old('marital_status') == 'single')
                                        >
                                            Single
                                        </option>
                                        <option
                                            value="divorced"
                                            @selected($staff->marital_status ?? old('marital_status')== 'divorced')
                                        >
                                            Divorced
                                        </option>
                                        <option
                                            value="widowed"
                                            @selected($staff->marital_status ?? old('marital_status')== 'widowed')
                                        >
                                            Widowed
                                        </option>
                                    </x-forms.select>
                                    <x-common.icon
                                        ...
                                        class="is-small is-left"
                                    />
                                    <x-common.validation-error property="martial_status" />
                                </x-forms.control>
                            </x-forms.field>
                        </div>
                        <div class="column is-6-mobile is-6-tablet is-3-desktop">
                            <x-forms.field>
                                ...
                                <x-forms.control class="has-icons-left is-fullwidth">
                                    <x-forms.input
                                        ...
                                        value="{{ $staff->date_of_birth ?? old('date_of_birth')}}"
                                    />
                                    <x-common.icon
                            ...
                            <x-forms.field>
                                ...
                                <x-forms.control class="has-icons-left">
                                    <x-forms.input
                                        ...
                                        value="{{ $staff->current_address ?? old('current_address')}}"
                                    />
                                    <x-common.icon
                            ...
                            <x-forms.field>
                                ...
                                <x-forms.control class="has-icons-left">
                                    <x-forms.input
                                        ...
                                        value="{{ $staff->permanent_address ?? old('permanent_address') }}"
                                    />
                                    <x-common.icon
                                        name="fas fa-map-marker-alt"
                                        class="is-small is-left"
                            ...
                            <x-forms.field>
                                ...
                                <x-forms.control class="has-icons-left is-fullwidth">
                                    <x-forms.input
                                        ...
                                        type="date"
                                        placeholder="mm/dd/yyyy"
                                        value="{{ $staff->staffCompensations->date_of_joining ?? now()->toDateString() }}"
                                    />
                                    <x-common.icon
                                        name="fas fa-calendar-alt"
                                        class="is-small is-left"
                            ...
                            <x-forms.field>
                                ...
                                <x-forms.control class="has-icons-left">
                                    <x-forms.input
                                        ...
                                        value="{{ $staff->staffCompensations->qualifications ?? old('qualifications') }}"
                                    />
                                    <x-common.icon
                                        name="fas fa-heading"
                                        class="is-small is-left"
                            ...
                            <x-forms.field>
                                ...
                                <x-forms.control class="has-icons-left">
                                    <x-forms.input
                                        ...
                                        value="{{ $staff->staffCompensations->experience ?? old('experience') }}"
                                    />
                                    <x-common.icon
                                        name="fas fa-heading"
                                        class="is-small is-left"
                            ...
                            <x-forms.field>
                                ...
                                <x-forms.control class="has-icons-left">
                                    <x-forms.input
                                        ...
                                        value="{{ $staff->staffCompensations->efp_number ?? old('efp_number')}}"
                                    />
                                    <x-common.icon
                                        name="fas fa-heading"
                                        class="is-small is-left"
                            ...
                            <x-forms.field>
                                ...
                                <x-forms.control class="has-icons-left">
                                    <x-forms.input
                                        ...
                                        value="{{ $staff->staffCompensations->basic_salary ?? old('basic_salary') }}"
                                    />
                                    <x-common.icon
                            ...
                            <x-forms.field>
                                ...
                                <x-forms.control class="has-icons-left ">
                                    ...
                                    >
                                        ...
                                        <option
                                            value="permanent"
                                            @selected($staff->staffCompensations->job_type ?? old('job_type') == 'permanent')
                                        > Permanent </option>
                                        <option
                                            value="contract"
                                            @selected($staff->staffCompensations->job_type ?? old('job_type') == 'contract')
                                        > Contract </option>
                                    </x-forms.select>
                                    <x-common.icon
                                        name="fas fa-sort"
                            ...
                            <x-forms.field>
                                ...
                                <x-forms.control class="has-icons-left">
                                    <x-forms.input
                                        ...
                                        value="{{ $staff->staffCompensations->location ?? old('location') }}"
                                    />
                                    <x-common.icon
                                        name="fas fa-map-marker-alt"
                                        class="is-small is-left"
                            ...
                            <x-forms.field>
                                ...
                                <x-forms.control class="has-icons-left">
                                    <x-forms.input
                                        ...
                                        value="{{ $staff->staffCompensations->bank_name ?? old('bank_name')}}"
                                    />
                                    <x-common.icon
                                        name="fas fa-bank"
                                        class="is-small is-left"
                            ...
                            <x-forms.field>
                                ...
                                <x-forms.control class="has-icons-left">
                                    <x-forms.input
                                        ...
                                        value="{{ $staff->staffCompensations->bank_detail ?? old('bank_account')}}"
                                    />
                                    <x-common.icon
                                        name="fas fa-hashtag"
                                        class="is-small is-left"
                            ...
                            <x-forms.field>
                                ...
                                <x-forms.control class="has-icons-left">
                                    <x-forms.input
                                        ...
                                        value="{{ $staff->staffCompensations->branch_name ?? old('branch_name') }}"
                                    />
                                    <x-common.icon
                                        name="fas fa-map-marker-alt"
                                        class="is-small is-left"
                            ...
                            <x-forms.field>
                                ...
                                <x-forms.control class="has-icons-left">
                                    <x-forms.input
                                        ...
                                        value="{{ $staff->staffCompensations->tin_number ?? old('tin_number')}}"
