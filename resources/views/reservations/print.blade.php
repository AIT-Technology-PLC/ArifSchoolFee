...
<body>
    ...
    <main>
        <x-print.customer :customer="$reservation->customer ?? ''" />
                ...
                <tbody>
                    @foreach ($reservation->reservationDetails as $reservationDetail)
                        <tr>
                            ...
                            @if (userCompany()->isDiscountBeforeVAT())
                                <td class="has-text-right"> {{ number_format($reservationDetail->discount * 100, 2) }}% </td>
                            @endif
                    ...
                    @if (!userCompany()->isDiscountBeforeVAT())
                        <tr>
                            ...
                            <td class="has-text-right has-text-weight-bold">{{ number_format($reservation->discount * 100, 2) }}%</td>
                        </tr>
                        <tr>
                            <td
                                colspan="5"
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <p>
                                    <span class="has-text-weight-bold is-uppercase">
                                        In Cash ({{ number_format($reservation->cashReceivedInPercentage, 2) }}%)
                                    </span>
                                    <br>
                                    <span>
                            ...
                            <td>
                                <p>
                                    <span class="has-text-weight-bold is-uppercase">
                                        On Credit ({{ number_format($reservation->creditPayableInPercentage, 2) }}%)
                                    </span>
                                    <br>
                                    <span>
    ...
    @if ($reservation->createdBy->is($reservation->approvedBy))
