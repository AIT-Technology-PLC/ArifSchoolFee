...
Route::resource('notifications', Resource\NotificationController::class)->only(['index', 'update']);
...
Route::resource('tender-details', Resource\TenderDetailController::class)->only('destroy');
