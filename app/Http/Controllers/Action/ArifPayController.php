...
use App\Http\Requests\ArifPayTransactionRequest;
...
{
    public function callback(ArifPayTransactionRequest $request)
    {
        ...
        $transaction = PaymentTransaction::pending()
            ->arifPay()->where('session_id', $request->sessionId)->first();
