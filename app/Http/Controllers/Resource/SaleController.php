...
class SaleController extends Controller
{
    ...
    public function show(Sale $sale, SaleDetailDatatable $datatable)
    {
        ...
        $sale->load(['saleDetails.product.tax', 'saleDetails.warehouse', 'saleDetails.merchandiseBatch', 'gdns', 'customer', 'contact', 'customFieldValues.customField', 'sivs.sivDetails']);
