...
class UpdateGdnRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'cash_received' => ['required', 'numeric', 'gte:0', new VerifyCashReceivedAmountIsValid($this->get('discount'), $this->get('gdn'), $this->get('cash_received_type')), function ($attribute, $value, $fail) {
