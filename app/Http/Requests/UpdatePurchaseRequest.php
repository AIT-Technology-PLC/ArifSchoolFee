...
class UpdatePurchaseRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'purchase.*.freight_cost' => ['nullable', 'numeric', 'required_if:type,Import'],
            'purchase.*.freight_insurance_cost' => ['nullable', 'numeric', 'required_if:type,Import'],
            'purchase.*.duty_rate' => ['nullable', 'numeric', 'min:0', 'max:100', 'required_if:type,Import'],
            'purchase.*.excise_tax' => ['nullable', 'numeric', 'min:0', 'max:100', 'required_if:type,Import'],
            'purchase.*.vat_rate' => ['nullable', 'numeric', 'min:0', 'max:100', 'required_if:type,Import'],
            'purchase.*.surtax' => ['nullable', 'numeric', 'min:0', 'max:100', 'required_if:type,Import'],
            'purchase.*.with_holding_tax' => ['nullable', 'numeric', 'min:0', 'max:100', 'required_if:type,Import'],
        ];
    }
}
