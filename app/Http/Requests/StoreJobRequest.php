...
class StoreJobRequest extends FormRequest
{
    ...
    {
        return [
            'code' => ['required', 'integer', new UniqueReferenceNum('jobs')],
            ...
            'assigned_to' => ['required', 'integer', new MustBelongToCompany('users')],
            ...
            'job.*.bill_of_material_id' => ['required', 'integer', new MustBelongToCompany('bill_of_materials')],
