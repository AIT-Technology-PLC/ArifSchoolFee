...
class UpdatePadRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'convert_to' => ['nullable', 'array', Rule::in((new Pad)->converts($this->route('pad')->company_id))],
            'convert_from' => ['nullable', 'array', Rule::in((new Pad)->converts($this->route('pad')->company_id))],
            ...
            'field.*.id' => ['nullable', 'integer', Rule::exists(PadField::class)],
