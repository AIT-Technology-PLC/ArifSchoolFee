...
class UpdateReservationRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'cash_received_type' => ['required_if:payment_type,Credit Payment', 'exclude_if:payment_type,Cash Payment', 'string', new VerifyCashReceivedAmountIsValid($this->get('discount'), $this->get('reservation'), $this->get('cash_received_type')), function ($attribute, $value, $fail) {
