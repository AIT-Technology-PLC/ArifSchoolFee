...
class StoreReturnRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'gdn_id' => ['nullable', 'required_if:customer_id,null', 'integer', new MustBelongToCompany('gdns'), Rule::in(Gdn::getValidGdnsForReturn()->flatten(1)->pluck('id'))],
            'customer_id' => ['nullable', 'required_if:gdn_id,null', 'integer', new MustBelongToCompany('customers'), Rule::in(Gdn::getValidGdnsForReturn()->flatten(1)->pluck('customer_id'))],
