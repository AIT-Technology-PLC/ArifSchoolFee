...
class JobPlannerService
{
    ...
    public static function jobPlannerDetail($details)
    {
        ...
        foreach ($details as $detail) {
            ...
            $factoryName = Warehouse::where('id', $detail['warehouse_id'])->first();
            ...
            for ($i = 0; $i < $length; $i++) {
                ...
                $productionCapability = ($availableAmount && $billOfMaterialDetail) ? number_format($availableAmount->available / $billOfMaterialDetail->quantity) : 0;
