...
class GdnService
{
    ...
    public function convertToCredit($gdn)
    {
        ...
        if (($gdn->cash_received == 100 && $gdn->cash_received_type == 'percent') || ($gdn->cash_received == $gdn->grandTotalPriceAfterDiscount && $gdn->cash_received_type == 'amount') || $gdn->payment_in_credit == 0) {
