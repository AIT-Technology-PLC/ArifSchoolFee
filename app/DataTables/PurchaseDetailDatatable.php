...
class PurchaseDetailDatatable extends DataTable
{
    ...
    protected function getColumns()
    {
        $columns = [
            ...
            Column::computed('duty_paying_value'),
            Column::computed('custom_duty_tax'),
            Column::computed('excise_tax'),
            Column::computed('value_added_tax'),
            Column::computed('surtax'),
            Column::computed('with_holding_tax'),
            Column::computed('total_payable_tax'),
            Column::computed('total_cost_after_tax'),
