...
class AssignFeeDiscountDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('checkbox', function ($student) {
                return view('components.datatables.add-discount-checkbox-action', compact('student'));
            })
            ->addIndexColumn();
    }
    ...
    {
        return 'Assign Fee Discounts_' . date('YmdHis');
    }
}
