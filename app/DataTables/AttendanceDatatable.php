...
class AttendanceDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('starting_period', fn($attendance) => $attendance->starting_period->toDayDateTimeString())
            ->editColumn('ending_period', fn($attendance) => $attendance->ending_period->toDayDateTimeString())
